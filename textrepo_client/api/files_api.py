...
class FilesApi(object):
    ...
    def put_file(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_file_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_file_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def put_file_with_http_info(self, id, **kwargs):  # noqa: E501
        """Create or update file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_file_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `put_file`")  # noqa: E501
